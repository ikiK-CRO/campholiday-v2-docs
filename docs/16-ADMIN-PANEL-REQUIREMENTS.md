...
## ⚙️ Settings (All Configurable via Admin Panel)
...
├────────────────────────────────────────────────────────────────┤
│                                                                │
│  Site Name:        [ Camp Holiday                    ]         │
│  Currency:         [ EUR ▼ ]                                   │
│  Timezone:         [ Europe/Zagreb ▼ ]                         │
│                                                                │
│  CONTACT INFORMATION                                           │
│  ──────────────────                                            │
│  Email:            [ info@campholiday.eu             ]         │
│  Phone:            [ +385 21 761 140                 ]         │
│  Address Line 1:   [ Camp Holiday                    ]         │
│  Address Line 2:   [ 21465 Jelsa                     ]         │
│  Address Line 3:   [ Hvar, Croatia                   ]         │
│                                                                │
│  RECEPTION HOURS                                               │
│  ──────────────                                                │
│  Summer (Jun-Sep): [ 08:00 ] to [ 22:00 ]                     │
│  Winter (Oct-May): [ 09:00 ] to [ 18:00 ]                     │
│                                                                │
│                                        [ Save Changes ]        │
└────────────────────────────────────────────────────────────────┘
```
...
│  ─────────────────────────                                     │
│  Check-in Time:    [ 14:00 ▼ ]  (Guests can arrive from)      │
│  Check-out Time:   [ 12:00 ▼ ]  (Guests must leave by)        │
│                                                                │
│  DEPOSIT SETTINGS                                              │
│  ────────────────                                              │
│  Require Deposit:  [✓] Yes                                     │
│  Deposit Amount:   [ 30 ]% of total booking                   │
│                                                                │
│  BOOKING RULES                                                 │
│  ─────────────                                                 │
│  Default Min Nights:     [ 2 ]                                 │
│  Max Advance Booking:    [ 365 ] days                         │
│  Auto-confirm Bookings:  [ ] No (require manual confirmation) │
│                                                                │
│                                        [ Save Changes ]        │
└────────────────────────────────────────────────────────────────┘
```
...
│  PARTIAL REFUND                                                │
│  ──────────────                                                │
│  [ 50 ]% refund if cancelled [ 7 ] to [ 14 ] days before     │
│                                                                │
│  NO REFUND                                                     │
│  ─────────                                                     │
│  No refund if cancelled within [ 7 ] days of check-in        │
│                                                                │
│  POLICY TEXT (shown to guests)                                 │
│  ─────────────────────────────                                 │
│  🇬🇧 English:                                                  │
│  ┌──────────────────────────────────────────────────────────┐ │
...
│  🇭🇷 Croatian:                                                 │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │ Besplatno otkazivanje do 14 dana prije dolaska.         │ │
│  │ 50% povrat 7-14 dana prije. Bez povrata unutar 7 dana.  │ │
│  └──────────────────────────────────────────────────────────┘ │
│                                                                │
│  [+ Add translation for DE, IT, FR]                           │
│                                                                │
│                                        [ Save Changes ]        │
└────────────────────────────────────────────────────────────────┘
```
...
├────────────────────────────────────────────────────────────────┤
│                                                                │
│  Adult Tax (18+):           €[ 1.20 ] per night               │
│  Youth Tax (5-17):          €[ 0.60 ] per night               │
│  Exempt under age:          [ 5 ] years                        │
│                                                                │
│  ℹ️ Tourist tax is collected on behalf of the Croatian        │
│     government and is automatically added to all bookings.    │
│                                                                │
│                                        [ Save Changes ]        │
└────────────────────────────────────────────────────────────────┘
```
...
- SMTP configuration (or use Resend API)
- Email templates (booking confirmation, reminder, etc.)
- Notification recipients (admin emails for new bookings)
